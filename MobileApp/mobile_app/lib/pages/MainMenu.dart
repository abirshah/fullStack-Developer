  ...
  Widget createBody(context)
  {
    return Column(
      ...
      children: [
        ...
        createRoundedCornerRaisedButton("Captured Images",onPress: (){goToPage(context,CapturedImagesPath);},minWidth: 100,height: 50),
        createRoundedCornerRaisedButton("Captured Videos",onPress: (){goToPage(context,CapturedVideosPath);},minWidth: 100,height: 50),
        createRoundedCornerRaisedButton("Add Pet",onPress: (){goToPage(context, AddPetPagePath);},minWidth: 100,height: 50),
        createRoundedCornerRaisedButton("Notifications",onPress: (){goToPage(context,NotificationsPath);},minWidth: 100,height: 50),
        createRoundedCornerRaisedButton("Access Information",onPress: (){goToPage(context,AccessInfoPath);},minWidth: 100,height: 50),
